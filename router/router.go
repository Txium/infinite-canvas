...
func New() *gin.Engine {
	...
	v1.GET("/media-ai/capabilities", gin.WrapF(handler.MediaAICapabilities))
	v1.GET("/voice-profiles", gin.WrapF(handler.VoiceProfiles))
	v1.POST("/voice-profiles", gin.WrapF(handler.SaveVoiceProfile))
	v1.POST("/media-ai/tasks", middleware.GenerationRateLimit, gin.WrapF(handler.SubmitMediaAI))
	...
	v1.POST("/chat/completions", middleware.GenerationRateLimit, gin.WrapF(handler.AIChatCompletions))
	v1.POST("/audio/speech", middleware.GenerationRateLimit, gin.WrapF(handler.AIAudioSpeech))
	v1.GET("/tts/voices", gin.WrapF(handler.AITTSVoices))
	v1.POST("/canvas/tasks/delete", gin.WrapF(handler.DeleteUserCanvasTasks))
	v1.POST("/canvas/image-tasks", middleware.GenerationRateLimit, gin.WrapF(handler.CreateCanvasImageTask))
	...
	v1.POST("/canvas/audio-tasks", middleware.GenerationRateLimit, gin.WrapF(handler.CreateCanvasAudioTask))
	...
	v1.POST("/videos", middleware.GenerationRateLimit, gin.WrapF(handler.AIVideos))
	...
	api.POST("/ai/direct-request", middleware.AdminAuth, gin.WrapF(handler.PrepareDirectAIRequest))
