...
export function createRechargeOrder(token: string, input: { amountCents: number; paymentMethod: string; paymentNote: string }) { return apiPost<RechargeOrder>("/api/v1/wallet/recharge-orders", input, token); }
