...
function InfiniteCanvasPage({ projectId }: { projectId: string }) {
    ...
    const toolbarNode = (toolbarNodeId ? nodeById.get(toolbarNodeId) : null) || (activeNodeId ? nodeById.get(activeNodeId) : null) || null;
    ...
    const handleRetryNode = useCallback(
        async (node: CanvasNodeData) => {
            ...
            // A canvas node is permanent, but each generation attempt must have
