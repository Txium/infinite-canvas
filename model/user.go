...
const (
	...
	CreditLogTypeRefundHold    CreditLogType = "payment_refund_hold"
	CreditLogTypeRefundRelease CreditLogType = "payment_refund_release"
	CreditLogTypePaymentRefund CreditLogType = "payment_refund"
