...
type ModelProvider struct {
	...
	UpstreamBalanceAmount      string `json:"upstreamBalanceAmount"`
	UpstreamBalanceCurrency    string `json:"upstreamBalanceCurrency"`
	UpstreamBalanceCheckedAt   string `json:"upstreamBalanceCheckedAt"`
	UpstreamBalanceAttemptedAt string `json:"upstreamBalanceAttemptedAt"`
	UpstreamBalanceError       string `json:"upstreamBalanceError"`
...
type ModelRoute struct {
	...
	CatalogCheckedAt    string `json:"catalogCheckedAt"`
	CatalogAutoDisabled bool   `json:"catalogAutoDisabled"`
	CreatedAt           string `json:"createdAt"`
	UpdatedAt           string `json:"updatedAt"`
}
