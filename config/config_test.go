...
func TestPaymentConfiguredAcceptsOfficialAlipay(t *testing.T) {
	Cfg = Config{AlipayAppID: "2021000000000000", AlipayAppPrivateKey: "private", AlipayPublicKey: "public", AlipayGatewayURL: "https://openapi.alipay.com/gateway.do", PublicBaseURL: "https://canvas.example.com"}
